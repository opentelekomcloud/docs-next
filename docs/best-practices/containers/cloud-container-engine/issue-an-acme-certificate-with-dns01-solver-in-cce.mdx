...
If you are using Open Telekom Cloud's native ingress controller, this will be whatever value you have set during the NGINX Ingress Controller installation for the **Parameters.Controller Name** parameter, which defaults to `nginx`.
