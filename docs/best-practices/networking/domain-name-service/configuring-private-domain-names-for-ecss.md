...
| ------ | ------- | ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------- |
| eu-de  | VPC     | VPC_001            | The DNS server addresses must be the same as the private DNS server addresses of T Cloud Public. For details, see [Availability of secondary DNS](https://www.open-telekom-cloud.com/en/support/release-notes/secondary-dns) | 1        | Free                                                                                                       |
