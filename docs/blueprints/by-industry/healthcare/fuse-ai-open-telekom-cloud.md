...
* The start-up now has scalable IT resources available all the time from the T Cloud Public.
* The company uses certified, highly secure data centers located in Germany.
* TCDP 1.0 certification attests that the T Cloud Public already conforms to the EU’s General Data Protection Regulation (GDPR).
