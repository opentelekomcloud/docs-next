...
The prerequisites for this guide are identical to those described in the blueprint [Build an Unified LLM Gateway with LiteLLM on CCE](/docs/blueprints/by-use-case/ai/litellm/build-an-unified-llm-gateway-with-litellm-on-cce.md). Before proceeding, 
ensure that all required services, infrastructure components, access permissions, and configuration prerequisites outlined in the blueprint have been 
completed. 
...
{/* | 🥇 | Multi-node pipeline parallelism      | Splitting model layers into sequential execution stages distributed across nodes         | Ray/KubeRay, multiple GPU-enabled nodes, pipeline stage configuration                        | Sequential stage execution can introduce additional latency            | */}
...
Standard vLLM inference deployments generally do not require this capability. In security-conscious 
Kubernetes environments, container capabilities should remain minimized unless explicitly needed 
by the workload or troubleshooting process, otherwise it can/should be omitted.
:::
...
- [vLLM Production Stack Documentation](https://docs.vllm.ai/en/stable/deployment/integrations/production-stack/)
- [Multi-GPU LLM Inference Guide — NVLink vs PCIe, Tensor Parallelism (2026)](https://willitrunai.com/blog/multi-gpu-llm-inference-guide)
- [Will It Run on your GPU or Mac?](https://willitrunai.com/blog/will-it-run-on-your-gpu-or-mac)
- [What Can My GPU Do?](https://willitrunai.com/my-gpu)
- [LMCache](https://lmcache.ai/)
- [Browse AI Models on WillItRunAI](https://willitrunai.com/browse?view=list)
- [LLM Leaderboard](https://llm-stats.com/)
- [OpenRouter AI Models Ranking](https://openrouter.ai/rankings)
:::