...
The prerequisites for this guide are identical to those described in the blueprint [Build a Unified LLM Gateway with LiteLLM on CCE](/docs/blueprints/by-use-case/ai/litellm/build-a-unified-llm-gateway-with-litellm-on-cce.md). Before proceeding, 
