...
![alt text](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-10 12-40-41.png)
...
![alt text](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-10 13-14-30.png)
...
![Establishing Connectivity](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-09 13-53-46.png)
...
![Adding Inbound Rules for RDS Instances](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-09 14-03-16.png)
...
![alt text](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-09 14-12-28.png)

### Creating Security Group for ECS

#### Creating Outbound Rule for PostgreSQL

![Adding Outbound Rules for ECS](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-09 14-10-01.png)
...
![alt text](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-09 14-16-19.png)
...
![alt text](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-10 12-47-36.png)
...
![alt text](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-10 14-38-26.png)

Configure *Frontend Protocol* as `TCP`, and *Frontend Port* as `80`:

![alt text](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-10 14-38-50.png)

Configure a new Routing Policy, supported by a new Backend Server Group and set *Backend Protocol* as `TCP`:

![alt text](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-10 14-39-09.png)
...
![alt text](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-10 14-39-38.png)

and set the Backend Port to `3000`:

![alt text](img/docs/blueprints/by-use-case/analytics/umami/Screenshot from 2024-09-10 14-39-50.png)
