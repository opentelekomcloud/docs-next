...
REDIS_PORT=6379
REDIS_USER=admin
REDIS_PASSWORD=REPLACE_WITH_VALUE
...
services:
  dokploy:
    ...
    environment:
      DATABASE_URL: >-
        postgres://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${POSTGRES_HOST}:${POSTGRES_PORT}/${POSTGRES_DB}?sslmode=require&options=-c%20search_path%3Dpublic
      REDIS_HOST: >-
