...
/* harmony export */   scale_grid_item: () => (/* binding */ GridItem)
/* harmony export */ });
...
const GridItem = class {
  ...
  componentWillLoad() {
    const setProps = [
      (0,_valuesTransformation_ce891c3a_js__WEBPACK_IMPORTED_MODULE_1__.c)('size', this.size),
      (0,_valuesTransformation_ce891c3a_js__WEBPACK_IMPORTED_MODULE_1__.c)('offset', this.offset),
    ].filter((setProp) => setProp);
    const cssStrings = setProps.map((setProp) => (0,_valuesTransformation_ce891c3a_js__WEBPACK_IMPORTED_MODULE_1__.a)(setProp));
