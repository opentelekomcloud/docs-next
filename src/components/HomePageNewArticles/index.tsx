        ...
        <div className='row' style={{ display: 'flex', gap: '8px', padding: '20px' }}>
          <div className={styles.card}>
            <NewsArticleCard 
              ...
              description="OpenDesk (branded as openDesk) is an open-source, sovereign digital workplace solution designed for public administration under the coordination of the German Federal Ministry of the Interior. This series of guides will showcases how to deploy a scalable, high-availability (HA) instances of OpenDesk on T Cloud Public."
