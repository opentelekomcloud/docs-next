...
const SERVICES: OtcService[] = [
  ...
  { id: "DMSForKafka", symbol: "DMS", name: "Distributed Message Service (for Kafka)", category: "Application", description: "Distributed Message Service for Kafka (DMS) is a message middleware service based on distributed, high-availability clustering technology. It provides reliable, scalable, and fully managed queues for storing messages.", hc_url: "https://docs.otc.t-systems.com/distributed-message-service/index.html", rn_url: "https://www.open-telekom-cloud.com/en/support/release-notes?tag=b361d1fd-5a7f-4061-94ad-8490f82e9c12", chips: ["PaaS"], regions: ["eu-de", "eu-nl"] },
  { id: "DMSForRocketMQ", symbol: "DMS-RocketMQ", name: "Distributed Message Service (for RocketMQ)", category: "Application", description: "Distributed Message Service for RocketMQ is a message-oriented middleware that provides low latency, high throughput, high reliability, and flexible scalability. It enables efficient communication between distributed systems and supports various messaging scenarios.", hc_url: "https://docs.otc.t-systems.com/distributed-message-service-rocketmq/index.html", rn_url: "https://www.open-telekom-cloud.com/en/support/release-notes?tag=b361d1fd-5a7f-4061-94ad-8490f82e9c12", chips: ["PaaS"], regions: ["eu-de", "eu-nl"] },
  ...
  { id: "UCS", symbol: "UCS", name: "Ubiquitous Cloud Native Service", category: "Containers", description: "Ubiquitous Cloud Native Service (UCS) is the industry's first ubiquitous cloud native service. Your cloud native applications can run freely across regions and clouds with intelligent traffic distribution, and enjoy consistent experience in deployment, management, and ecosystem.", hc_url: "https://docs.otc.t-systems.com/ubiquitous-cloud-native-service/index.html", rn_url: "https://www.t-cloud-public.com/en/support/release-notes?tag=aee8de03-67db-4a27-94ec-760822687381", chips: ["PaaS"], regions: ["eu-de", "eu-nl"] },
  ...
  { id: "EPS", symbol: "EPS", name: "Enterprise Project Service", category: "Management & Deployment", description: "Enterprise Project Service (EPS) enables centralized management of resources across multiple projects and supports the structured organization of cloud resources in larger environments.", hc_url: "https://docs.otc.t-systems.com/enterprise-project-service/index.html", rn_url: "https://www.t-cloud-public.com/en/support/release-notes?tag=d00ac98e-b6df-43e1-8032-d96cd60da984", chips: ["Management"], regions: ["eu-de", "eu-nl"] },
  ...
  // Network
  { id: "CloudConnect", symbol: "CCN", name: "Cloud Connect", category: "Network", description: "Cloud Connect provides central networks that allow you to connect Virtual Private Clouds (VPCs) in different regions, so that these VPCs can communicate over a private network as if they were within the same network. Cloud Connect can also work with Direct Connect to set up a hybrid cloud network that enables on-premises data centers to access the VPCs across regions.", hc_url: "https://docs.otc.t-systems.com/cloud-connect/index.html", rn_url: "https://www.t-cloud-public.com/en/support/release-notes?tag=e0c15b7d-2503-4ddd-b00f-38352cccbdb1", chips: ["IaaS"], regions: ["eu-de", "eu-nl"] },
  ...
  { id: "ESW", symbol: "ESW", name: "Enterprise Switch", category: "Network", description: "Enterprise switches enable communications between cloud and on-premises networks at Layer 2. This allows you to migrate workloads in data centers or private clouds to the cloud without changing subnets and IP addresses.", hc_url: "https://docs.otc.t-systems.com/enterprise-switch/index.html", rn_url: "https://www.t-cloud-public.com/en/support/release-notes?tag=dc0f1560-f6f8-4450-bee6-a2283396d371", chips: ["IaaS"], regions: ["eu-de", "eu-nl"] },
